...
function creationRanking(id) {
    ...
    $.get({
        ...
        success: function (data, status, xhr) {
            ...
            //List<AuthorWorkNumber>
            for (var i=0; i< data.length; i++) {
                var authorWorkNumber  = data[i];
                options.xAxis.data.push(authorWorkNumber.author);
                options.series[0].data.push(authorWorkNumber.worknumber);
            }
        ...
        success: function (data, status, xhr) {
            ...
            var options = {
                series: [{
                    ...
                    // Data is an array. Each array item must have name and
                    // value property.
                    data: []
                }]
            };
